    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <div style={styles.section}>
          ...
          <select
            style={styles.input}
            name="admin_tipo_documento"
            value={form.admin_tipo_documento}
          ...
          <input style={styles.input} name="admin_id_municipio" type="number" placeholder="ID Municipio" onChange={handleChange} />
        </div>
